angular.module("ShinyaApp",["ngRoute","ngTouch","ngAnimate","angular-jwt","angular-storage","duScroll","pascalprecht.translate","ShinyaApp.posHelperServices","ShinyaApp.timeHelperServices","ShinyaApp.geoHelperServices","ShinyaApp.msgHelperServices","ShinyaApp.logoDirective","ShinyaApp.notifyDirective","ShinyaApp.autofocusDirective","ShinyaApp.hideKeyboardDirective","ShinyaApp.imageonloadDirective","ShinyaApp.autoscrollDirective","ShinyaApp.imgDirective","ShinyaApp.beepDirective","ShinyaApp.usercountDirective","ShinyaApp.i18nDirective","ShinyaApp.submitController","ShinyaApp.chatController","ShinyaApp.forgotController"]).config(["$routeProvider","$locationProvider","$httpProvider","jwtInterceptorProvider","$translateProvider",function(E,e,S,O,T){e.html5Mode(!0),E.when("/",{templateUrl:"/public/dist/submit.min.html",controller:"submitController"}).when("/chat",{templateUrl:"/public/dist/chat.min.html",controller:"chatController"}).when("/forgot",{templateUrl:"/public/dist/forgot.min.html",controller:"forgotController"}).otherwise({redirectTo:"/"}),O.tokenGetter=["store",function(E){return E.get("id_token")}],S.interceptors.push("jwtInterceptor"),T.translations("en",{login:{TITLE:"Log In",USERNAME:"Username / Email",FORGOT_TITLE:"Forgot Password",SUBMIT_TITLE:"Log In"},register:{TITLE:"Sign Up",USERNAME:"Username",SUBMIT_TITLE:"Sign Up"},general:{EMAIL:"Email",PASSWORD:"Password"},forgot:{TITLE:"Find Your Account",NEW_PASSWORD:"New Password",CODE:"Verification Code",NEXT_STEP:"Next Step"},chat:{USER_COUNT:"Online User: ",JOINED:"Joined",NUMERO_PREFIX:"No. ",NUMERO_SUBFFIX:"",DATE_FORMAT:"MM/dd/yyyy",TIME_FORMAT:"HH:mm:ss",SOUND:"Sound",LOCATION:"Location",LOCATION_SERVICES:"Location Services",VERSION:"Version",LOG_OUT:"Log Out",VIEW_ORIGINAL:"View Original",NEWS_SOURCES:"News Sources: ",TODAY:"TDA",NOW:"Now",THE_DAY_WEATHER:"The Day's Weather",THE_DAY_NEWS:"The Day's News",TODAY_NEWS:"Today's News",GEO_ON_MSG:"Success, Please re-login",GEO_OFF_MSG:"Success, Please re-login",NEWS_NOT_EXIST:"News does not exist",NETWORK_ERROR_MSG:"Network Error, Please try again later"},time:{DAWN:"AM",MORNING:"AM",FORENOON:"AM",AFTERNOON:"PM",EVENING:"PM",DUSK:"PM",MIDNIGHT:"PM"},error:{SERVER_ERROR:"Server Error",USER_EXIST:"User already exists",USER_NOT_EXIST:"User does not exist",EMAIL_EXIST:"Email already exists",EMAIL_NOT_EXIST:"Email address does not exist",EMAIL_INCORRECT:"Email address is incorrect",PASSWORD_REQUIRED:"Password is required",PASSWORD_INCORRECT:"Password is incorrect",CODE_LATEST:"Not THE LATEST Code",CODE_EXPIRED:"Verification Code expired",CODE_ERROR:"Incorrect Verification Code",CODE_WHAT:"WHAT?",USERNAME_SPACES:"Username can't contain spaces",USERNAME_LENGTH:"Max length of Username: 16"},ok:{RELOGIN:"Please re-login",NEW_PASSWORD:"Please enter new password",ENTER_CODE:"Enter the Code you received",PASSWORD_CHANGED:"Password Changed Successfully",SIGNED_UP:"Sign Up Successfully"}}).translations("zh-HK",{login:{TITLE:"登入",USERNAME:"使用者名稱／電郵地址",FORGOT_TITLE:"忘記密碼",SUBMIT_TITLE:"登入"},register:{TITLE:"註冊",USERNAME:"使用者名稱",SUBMIT_TITLE:"註冊"},general:{EMAIL:"電郵地址",PASSWORD:"密碼"},forgot:{TITLE:"尋找你的帳戶",NEW_PASSWORD:"新密碼",CODE:"驗證碼",NEXT_STEP:"下一步"},chat:{USER_COUNT:"線上人數：",JOINED:"加入於",NUMERO_PREFIX:"第 ",NUMERO_SUBFFIX:" 號用戶",DATE_FORMAT:"yyyy 年 M 月 d 日",TIME_FORMAT:"HH 時 mm 分",SOUND:"聲音",LOCATION:"位置",LOCATION_SERVICES:"位置服務",VERSION:"版本",LOG_OUT:"登出",VIEW_ORIGINAL:"查看原圖",NEWS_SOURCES:"新聞來源：",TODAY:"今日",NOW:"現在",THE_DAY_WEATHER:"當日天氣",THE_DAY_NEWS:"當日新聞",TODAY_NEWS:"今日新聞",GEO_ON_MSG:"已開啟服務，請重新登入",GEO_OFF_MSG:"已關閉服務，請重新登入",NEWS_NOT_EXIST:"此時段新聞不存在",NETWORK_ERROR_MSG:"網路錯誤，請稍候再試"},time:{DAWN:"破曉",MORNING:"早晨",FORENOON:"午前",AFTERNOON:"午後",EVENING:"傍晚",DUSK:"薄暮",MIDNIGHT:"深夜"},error:{SERVER_ERROR:"伺服器錯誤",USER_EXIST:"使用者名稱已存在",USER_NOT_EXIST:"使用者名稱不存在",EMAIL_EXIST:"電郵地址已存在",EMAIL_NOT_EXIST:"電郵地址不存在",EMAIL_INCORRECT:"電郵地址不正確",PASSWORD_REQUIRED:"請輸入您的密碼",PASSWORD_INCORRECT:"密碼不正確",CODE_LATEST:"請輸入最新的驗證碼",CODE_EXPIRED:"驗證碼已經過期了",CODE_ERROR:"這個碼不是我發的",CODE_WHAT:"我不知道你說什麼",USERNAME_SPACES:"使用者名稱不能包含空格",USERNAME_LENGTH:"使用者名稱不能超過十六個字符"},ok:{RELOGIN:"請重新登入",NEW_PASSWORD:"請輸入新密碼",ENTER_CODE:"請輸入收到的驗證碼",PASSWORD_CHANGED:"修改密碼成功",SIGNED_UP:"註冊成功"}}).translations("zh-TW",{login:{TITLE:"登入",USERNAME:"使用者名稱／電子郵件地址",FORGOT_TITLE:"忘記密碼",SUBMIT_TITLE:"登入"},register:{TITLE:"註冊",USERNAME:"使用者名稱",SUBMIT_TITLE:"註冊"},general:{EMAIL:"電子郵件地址",PASSWORD:"密碼"},forgot:{TITLE:"尋找你的帳戶",NEW_PASSWORD:"新密碼",CODE:"驗證碼",NEXT_STEP:"下一步"},chat:{USER_COUNT:"線上人數：",JOINED:"加入於",NUMERO_PREFIX:"第 ",NUMERO_SUBFFIX:" 號用戶",DATE_FORMAT:"yyyy/MM/dd",TIME_FORMAT:"HH:mm:ss",SOUND:"聲音",LOCATION:"位置",LOCATION_SERVICES:"位置服務",VERSION:"版本",LOG_OUT:"登出",VIEW_ORIGINAL:"查看原圖",NEWS_SOURCES:"新聞來源：",TODAY:"今日",NOW:"現在",THE_DAY_WEATHER:"當日天氣",THE_DAY_NEWS:"當日新聞",TODAY_NEWS:"今日新聞",GEO_ON_MSG:"已開啟服務，請重新登入",GEO_OFF_MSG:"已關閉服務，請重新登入",NEWS_NOT_EXIST:"此時段新聞不存在",NETWORK_ERROR_MSG:"網路錯誤，請稍候再試"},time:{DAWN:"破曉",MORNING:"早晨",FORENOON:"午前",AFTERNOON:"午後",EVENING:"傍晚",DUSK:"薄暮",MIDNIGHT:"深夜"},error:{SERVER_ERROR:"伺服器錯誤",USER_EXIST:"使用者名稱已存在",USER_NOT_EXIST:"使用者名稱不存在",EMAIL_EXIST:"電子郵件地址已存在",EMAIL_NOT_EXIST:"電子郵件地址不存在",EMAIL_INCORRECT:"電子郵件地址不正確",PASSWORD_REQUIRED:"請輸入您的密碼",PASSWORD_INCORRECT:"密碼不正確",CODE_LATEST:"請輸入最新的驗證碼",CODE_EXPIRED:"驗證碼已經過期了",CODE_ERROR:"這個碼不是我發的",CODE_WHAT:"我不知道你說什麼",USERNAME_SPACES:"使用者名稱不能包含空格",USERNAME_LENGTH:"使用者名稱不能超過十六個字符"},ok:{RELOGIN:"請重新登入",NEW_PASSWORD:"請輸入新密碼",ENTER_CODE:"請輸入收到的驗證碼",PASSWORD_CHANGED:"修改密碼成功",SIGNED_UP:"註冊成功"}}).translations("zh-CN",{login:{TITLE:"登录",USERNAME:"用户名／邮箱地址",FORGOT_TITLE:"忘记密码",SUBMIT_TITLE:"登录"},register:{TITLE:"注册",USERNAME:"用户名",SUBMIT_TITLE:"注册"},general:{EMAIL:"邮箱地址",PASSWORD:"密码"},forgot:{TITLE:"寻找你的账号",NEW_PASSWORD:"新密码",CODE:"验证码",NEXT_STEP:"下一步"},chat:{USER_COUNT:"在线人数：",JOINED:"加入于",NUMERO_PREFIX:"第 ",NUMERO_SUBFFIX:" 号用户",DATE_FORMAT:"yyyy 年 M 月 d 日",TIME_FORMAT:"HH 时 mm 分",SOUND:"声音",LOCATION:"位置",LOCATION_SERVICES:"位置服务",VERSION:"版本",LOG_OUT:"注销",VIEW_ORIGINAL:"查看原图",NEWS_SOURCES:"新闻来源：",TODAY:"今日",NOW:"现在",THE_DAY_WEATHER:"当日天气",THE_DAY_NEWS:"当日新闻",TODAY_NEWS:"今日新闻",GEO_ON_MSG:"已开启服务，请重新登录",GEO_OFF_MSG:"已关闭服务，请重新登录",NEWS_NOT_EXIST:"此时段新闻不存在",NETWORK_ERROR_MSG:"网络错误，请稍候再试"},time:{DAWN:"破晓",MORNING:"早晨",FORENOON:"午前",AFTERNOON:"午后",EVENING:"傍晚",DUSK:"薄暮",MIDNIGHT:"深夜"},error:{SERVER_ERROR:"服务器错误",USER_EXIST:"用户名已存在",USER_NOT_EXIST:"用户名不存在",EMAIL_EXIST:"邮箱地址已存在",EMAIL_NOT_EXIST:"邮箱地址不存在",EMAIL_INCORRECT:"邮箱地址不正確",PASSWORD_REQUIRED:"请输入你的密码",PASSWORD_INCORRECT:"密码不正确",CODE_LATEST:"请输入最新的验证码",CODE_EXPIRED:"验证码已过期",CODE_ERROR:"验证码有误",CODE_WHAT:"验证码有误",USERNAME_SPACES:"用户名不能包含空格",USERNAME_LENGTH:"用户名不能超过十六个字符"},ok:{RELOGIN:"请重新登录",NEW_PASSWORD:"请输入新密码",ENTER_CODE:"请输入收到的验证码",PASSWORD_CHANGED:"修改密码成功",SIGNED_UP:"注册成功"}}).preferredLanguage("zh-HK").useStorage("a0-angular-storage")}]).factory("a0-angular-storage",["store",function(E){return{put:function(e,S){E.set(e,S)},get:function(e){return E.get(e)}}}]).controller("rootController",["$rootScope","$scope","$timeout","$location","$route","$window","jwtHelper","store",function(E,e,S,O,T,r,R,_){function t(){var E=r.navigator.userAgent;return E.match(/Android/i)||E.match(/webOS/i)||E.match(/iPhone/i)||E.match(/iPad/i)||E.match(/iPod/i)||E.match(/BlackBerry/i)||E.match(/Windows Phone/i)?!0:!1}e.isLogoLoaded=!1,E.isSubmit=!0,E.lastInfo=[],E.isMobile=t(),!r.navigator.standalone&&E.isMobile,e.$on("$routeChangeStart",function(E,e,S,T){var r=_.get("id_token");"/"===O.path()?r?R.isTokenExpired(r)?null:O.path("/chat").replace():null:"/chat"===O.path()&&(!r||R.isTokenExpired(r)?O.path("/").replace():null)})}]);
...
angular.module("ShinyaApp.timeHelperServices",[]).service("syTimeHelper",["$translate",function(t){this.partsOfADay=function(e){return t.instant(3>=e?"time.MIDNIGHT":6>=e?"time.DAWN":9>=e?"time.MORNING":12>=e?"time.FORENOON":15>=e?"time.AFTERNOON":18>=e?"time.EVENING":21>=e?"time.DUSK":"time.MIDNIGHT")},this.getNumero=function(t){return 77>t?"gold":177>t?"aluminum":"steel"},this.getDaytimeOrNight=function(t){return t>6&&18>t?"daytime":"night"},this.getDayMs=function(t){var t=new Date(t);return Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate())},this.isSameDay=function(t,e){return this.getDayMs(t)===this.getDayMs(e)}}]);
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","$route","$translate","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,a,r,g,l,c,u,h,w,f){function x(){t.isTodayNews=!1,t.isShowNewsOptions=!1,t.isOtherDateNews=!1}function d(){var e,o;1===t.selectDate?(e=24,o=t.selectDate+1):24===t.selectDate?(e=23,o=1):(e=t.selectDate-1,o=t.selectDate+1),t.isShowPreHour=t.isTodayNews&&e>(new Date).getHours()?!1:!0,t.isShowNextHour=t.isTodayNews&&o>(new Date).getHours()?!1:!0}function m(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function B(o){var s=e.socket.id===o.id,n=u.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:f.isShowDate(o.date),date:o.date,msg:f.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0?t.img_list[o.date]=f.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?u.scrollToPos():o.at&&o.at.indexOf("@"+p.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function N(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:p.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:f.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=f.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){B(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function S(){e.socket=io("",{query:"token="+y,secure:!0}),N()}function D(){e.socket.disconnect(),e.socket.connect("",{query:"token="+y,secure:!0}),N()}function _(){for(var e=n.localStorage,t=localStorage.length,o=/^one-day-news-/,s=0,i=0;t>i;i++)o.test(e.key(s))?c.remove(e.key(s)):s++}e.isSubmit=!1,t.isSun="daytime"===h.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isChatBox=!0,t.isInfoBox=!1,t.isShowNewsOptions=!1,t.isLoadErr=!1,t.toggleChatBox=function(e,o){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox,o?x():null):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,o?x():null),t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1},t.currentPage="infoBox",t.currentPageIs=function(e){return t.currentPage===e},t.toggleCurrentPage=function(e,o){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),o?x():null,s(function(){t.currentPage=e})},t.i18n_JOIN=g.instant("chat.JOINED"),t.i18n_DATE_FORMAT=g.instant("chat.DATE_FORMAT"),t.i18n_TIME_FORMAT=g.instant("chat.TIME_FORMAT"),t.$on("$translateChangeBeforeStart",function(){t.toggleCurrentPage("loadBox")}),e.$on("$translateChangeSuccess",function(){r.reload()});var y=c.get("id_token"),p=l.decodeToken(y);t.infoBox={title:g.instant("chat.JOINED"),username:p.username,numero:p.numero,date:a("date")(p.date,t.i18n_DATE_FORMAT),country:p.country,partsOfADay:h.partsOfADay(~~a("date")(p.date,"H")),weather:p.weather.description},console.log(t.infoBox,t.i18n_JOIN),t.numero=function(e){return h.getNumero(t.infoBox.numero)},t.getDaytimeOrNight=h.getDaytimeOrNight(~~a("date")(p.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==w.getCityWeatherType(p.weather.code)?(t.partWeather="",t.infoBox.title=g.instant("chat.JOINED")):(t.partWeather=w.getCityWeatherType(p.weather.code),t.infoBox.title=g.instant("chat.THE_DAY_WEATHER"))},t.otherUserInfo={},t.otherUserInfoId=0,t.isOtherDateNews=!1,t.toggleOtherUserInfo=function(e,s){return s===t.otherUserInfoId?void(t.otherUserInfoId=0):void(c.get(e)?(t.otherUserInfo=c.get(e),t.otherUserInfoId=s):o.post("/api/getUserInfo",{username:e}).success(function(o,n,i,a){var r={username:e,numero:o.msg.numero,country:o.msg.country||"CN",date:o.msg.date};c.set(e,r),t.otherUserInfo=r,t.otherUserInfoId=s}).error(function(e,t,o,s){}))},t.getOtherDateNews=function(e){t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.isTodayNews=!1,t.isOtherDateNews=!0,t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1,t.selectDate=(new Date).getHours(),d(),t.getSelectedDateNews(e,t.otherUserInfo.date,!0)},t.isTodayNews=!1,t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg=g.instant("chat.NEWS_NOT_EXIST"),t.newsDateTitle=g.instant("chat.THE_DAY_NEWS"),t.selectDateNewsBox=[],t.selectDate=(new Date).getHours(),t.selectCountry=c.get("NG_TRANSLATE_COUNTRY")||t.infoBox.country||"CN";var C=(new Date).getTimezoneOffset()/60,O=c.getNamespacedStore("one-day-news","-"),I=function(e,n){var i=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{username:n,selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:C,isTodayNews:t.isTodayNews}).success(function(t,o,n,a){s.cancel(i),e("ok",t.msg)}).error(function(o,n,a,r){401===n?t.quit():(400===n?s.cancel(i):null,e("error",o.msg||g.instant("chat.NETWORK_ERROR_MSG")))})},E=function(e,t){O.set(e,t);var o=Date.now()+864e5;c.set("oneDayNewsExpires",h.getDayMs(o))},v=function(){t.isOtherDateNews?t.getSelectedDateNews(t.otherUserInfo.username,t.otherUserInfo.date,!0):t.isTodayNews?t.getSelectedDateNews(null,Date.now(),!0):t.getSelectedDateNews(null,p.date)};t.toggleTodayNews=function(){t.isTodayNews?(t.isTodayNews=!1,t.selectDate=(new Date).getHours(),d(),t.getSelectedDateNews(null,p.date)):(t.isTodayNews=!0,t.selectDate=(new Date).getHours(),d(),t.getSelectedDateNews(null,Date.now(),!0))},t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",v()},t.getSelectedDateNews=function(e,o,s){var e=e||p.username,o=o||Date.now(),s=s||!1,n=h.getDayMs(o)+t.selectCountry+t.selectDate,i=s?O.get(n):c.get(n);t.isShowNewsOptions=!0,t.newsDateTitle=g.instant(t.isTodayNews?"chat.TODAY_NEWS":"chat.THE_DAY_NEWS"),t.isLoadErr=!1,i?(t.selectDateNewsBox=i,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),I(function(e,o){"ok"===e?(t.isNewsExist?null:t.toggleNewsExist(),o?s?E(n,o):c.set(n,o):t.isNewsExist?t.toggleNewsExist():null,t.selectDateNewsBox=o,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=o,t.isNewsExist?t.toggleNewsExist():null)},e))},t.isShowPreHour=!0,t.isShowNextHour=!0,t.preHour=function(){t.isShowPreHour&&(t.selectDate>1?(t.selectDate--,v()):(t.selectDate=24,v()),d())},t.nextHour=function(){t.isShowNextHour&&(t.selectDate<24?(t.selectDate++,v()):(t.selectDate=1,v()),d())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!c.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,c.set("isMuted",t.isMuted)},t.quit=function(){c.remove("id_token"),c.remove("isGeoServices"),e.lastInfo[0]=p.username,t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=c.get("isGeoServices")||p.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(o,n,i,a){"on"===o.msg?(c.set("isGeoServices",!0),e.lastInfo[1]="gotoGeoBox",s(function(){e.$broadcast("turnOnGeoServices",g.instant("chat.GEO_ON_MSG"))},100)):(c.set("isGeoServices",!1),s(function(){e.$broadcast("turnOffGeoServices",g.instant("chat.GEO_OFF_MSG"))},100)),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,a){s.cancel(e);var r=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,l=o.msg.now_geo.weather.code,c=o.msg.now_geo.weather.isNight;last_weather=w.getGeoWeatherType(r,g),now_weather=w.getGeoWeatherType(l,c),t.geoBox=o.msg,t.geoBox.distance=w.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=h.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){m("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){m("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isShowAtUserBox=!1,t.toggleAtUserBox=function(){t.isShowAtUserBox=!t.isShowAtUserBox},t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(o,s){var n=o.match(/\@([^\s\@]){1,16}/g);if(n&&n!==t.atUser){for(var i=n.length,a=0;i>a;a++)t.atUser.indexOf(n[a])<0?t.atUser.push(n[a]):null;for(var r=t.atUser.length,a=0;r>a;a++)n.indexOf(t.atUser[a])<0?t.atUser.splice(a,1):null}else t.atUser=[];o.match(/\@$/g)&&(t.isShowAtUserBox=!0,e.isMobile?document.getElementById("chat_submit_input").blur():null),(s.match(/\@$/g)||o.match(/\@([^\s\@]){1,16}\s$/g))&&(t.isShowAtUserBox=!1,e.isMobile,document.getElementById("chat_submit_input").focus())}),t.removeAtUser=function(e){var o=new RegExp("\\s?"+e+"\\s?","g");t.msgOutbox.textMsg=t.msgOutbox.textMsg.replace(o,"")},t.addAtUser=function(o){var s=t.msgOutbox.textMsg;s.match(o)?null:t.msgOutbox.textMsg=s.concat(s.match(/\@$/g)?o+" ":"@"+o+" "),e.isMobile||t.isChatBox?null:t.toggleChatBox(null,!0)},t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1,t.isShowAtUserBox=!1},e.socket?D():S();var M=e.lastInfo[0],T=e.lastInfo[1];M&&M!==p.username?(e.lastInfo=[],n.location.reload()):T&&"gotoGeoBox"===T?(e.lastInfo=[],t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices()):e.lastInfo=[],c.get("oneDayNewsExpires")<Date.now()?_():null}]);
angular.module("ShinyaApp.forgotController",[]).controller("forgotController",["$scope","$rootScope","$http","$timeout","$location","$translate",function(o,t,r,s,i,e){t.isSubmit=!1,o.isMsgNotify=!1,o.errMsg="",o.okMsg="",o.msgNotify=function(t,r){"error"===t?(o.input_shake_animate=!0,o.errMsg=e.instant(r),o.isMsgNotify=!0,s(function(){o.errMsg="",o.input_shake_animate=!1,o.isMsgNotify=!1},1717)):"ok"===t?(o.okMsg=e.instant(r),o.isMsgNotify=!0,s(function(){o.okMsg="",o.isMsgNotify=!1},1717)):console.error("[TypeError]: Not `error` or `ok`")},o.forgot={},o.step=1,o.returnToPreviousStep=function(){1===o.step?i.path("/"):o.step=o.step-1},o.gotoStepThree=function(){o.step=3,o.msgNotify("ok",e.instant("ok.NEW_PASSWORD"))},o.forgotEmailSubmit=function(){r.post("/forgot_email",{email:o.forgot.email}).success(function(t,r,s,i){o.step=2,o.msgNotify("ok",t.msg)}).error(function(t,r,s,i){o.msgNotify("error",t.msg)}),o.forgot={}},o.forgotCodeSubmit=function(){r.post("/forgot_code",{code:o.forgot.code,password:o.forgot.password}).success(function(t,r,e,n){o.msgNotify("ok",t.msg),s(function(){i.path("/")},2e3)}).error(function(t,r,i,e){o.msgNotify("error",t.msg),s(function(){o.returnToPreviousStep()},717)}),o.forgot={}}}]);
angular.module("ShinyaApp.submitController",[]).controller("submitController",["$scope","$rootScope","$http","$timeout","$location","$route","$window","jwtHelper","store","$translate",function(o,t,i,n,e,s,r,g,a,u){t.isSubmit=!0,o.isMsgNotify=!1,o.errMsg="",o.okMsg="",o.msgNotify=function(t,i){"error"===t?(o.input_shake_animate=!0,o.errMsg=u.instant(i),o.isMsgNotify=!0,n(function(){o.errMsg="",o.input_shake_animate=!1,o.isMsgNotify=!1},1717)):"ok"===t?(o.okMsg=u.instant(i),o.isMsgNotify=!0,n(function(){o.okMsg="",o.isMsgNotify=!1},1717)):console.error("[TypeError]: Not `error` or `ok`")},a.get("id_token")&&g.isTokenExpired(a.get("id_token"))&&n(function(){o.msgNotify("ok",u.instant("ok.RELOGIN"))},0),o.$on("turnOnGeoServices",function(t,i){n(function(){o.msgNotify("ok",i)},0)}),o.$on("turnOffGeoServices",function(t,i){n(function(){o.msgNotify("ok",i)},0)}),o.isShowLoadAnimate=!1,o.$on("$translateChangeBeforeStart",function(){o.isShowLoadAnimate=!0}),t.$on("$translateChangeSuccess",function(){s.reload()}),o.isLogin=!0,o.toggleSubmit=function(){o.isLogin=!o.isLogin},o.login={},o.register={},o.loginSubmit=function(){i.post("/login",{user:o.login.user,password:o.login.password}).success(function(o,t,i,n){a.set("id_token",o.token),e.path("/chat").replace()}).error(function(t,i,n,e){o.msgNotify("error",t.msg)}),o.login={}},o.registerSubmit=function(){i.post("/register",{username:o.register.username,email:angular.lowercase(o.register.email),password:o.register.password}).success(function(t,i,n,e){o.msgNotify("ok",t.msg),o.toggleSubmit()}).error(function(t,i,n,e){o.msgNotify("error",t.msg)}),o.register={}}}]);

...
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,a,r,g,c,u,l,x){function m(e){var n=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{selectDate:t.selectDate,timezoneOffset:t.timezoneOffset}).success(function(t,o,i,a){s.cancel(n),e("ok",t.msg)}).error(function(o,s,n,i){401===s?t.quit():e("error",o.msg||"網絡出錯，請稍候再試")})}function f(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function d(o){var s=e.socket.id===o.id,n=c.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:x.isShowDate(o.date),date:o.date,msg:x.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0&&(t.img_list[o.date]=x.imgSanitization(o.img_list))}),(n||s)&&t.isChatBox?c.scrollToPos():o.at&&o.at.indexOf("@"+S.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function w(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:S.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:x.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0&&(t.img_list[e[s].date]=x.imgSanitization(e[s].img_list))})})}),e.socket.on("textMsg",function(e){d(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function h(){e.socket=io("",{query:"token="+p,secure:!0}),w()}function B(){e.socket.disconnect(),e.socket.connect("",{query:"token="+p,secure:!0}),w()}e.isSubmit=!1,t.isChatBox=!0,t.isSun="daytime"===u.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isInfoBox=!1,t.toggleChatBox=function(e){e?"left"===e?t.isChatBox&&(t.isChatBox=!t.isChatBox):"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox):(t.isChatBox||t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun),t.now_img_list=[],t.isZoomIn=!1},t.currentPage="infoBox",t.toggleCurrentPage=function(e){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),s(function(){t.currentPage=e})};var p=g.get("id_token"),S=r.decodeToken(p);t.infoBox={title:"加入於",username:S.username,numero:S.numero,date:a("date")(S.date,"yyyy 年 M 月 d 日"),partsOfADay:u.partsOfADay(~~a("date")(S.date,"H")),weather:S.weather.description},t.numero=u.getNumero(t.infoBox.numero),t.getDaytimeOrNight=u.getDaytimeOrNight(~~a("date")(S.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==l.getCityWeatherType(S.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=l.getCityWeatherType(S.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.newsBox={},t.selectDateNewsBox=[],t.timezoneOffset=(new Date).getTimezoneOffset()/60,t.selectDate=(new Date).getHours(),t.getSelectedDateNews=function(){t.selectDate in t.newsBox?(t.selectDateNewsBox=t.newsBox[t.selectDate],"infoBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.isNewsExist||t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),m(function(e,o){"ok"===e?(t.newsBox[t.selectDate]=o,t.selectDateNewsBox=t.newsBox[t.selectDate],"loadBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.isNewsExist||t.toggleNewsExist()):("loadBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.newsErrMsg=o,t.isNewsExist&&t.toggleNewsExist())}))},t.previousHour=function(){t.selectDate>1?(t.selectDate--,t.getSelectedDateNews()):(t.selectDate=24,t.getSelectedDateNews())},t.nextHour=function(){t.selectDate<24?(t.selectDate++,t.getSelectedDateNews()):(t.selectDate=1,t.getSelectedDateNews())},t.gotoSettingBox=function(){"infoBox"===t.currentPage&&t.toggleCurrentPage("settingBox")},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||S.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(e,o,s,n){"on"===e.msg?(g.set("isGeoServices",!0),g.set("nextStep","geoServices"),t.$emit("preTurnOnGeoServices","已開啟服務，請重新登錄")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","已關閉服務，請重新登錄")),t.quit()}).error(function(e,o,s,n){401===o&&t.quit()})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage&&t.toggleCurrentPage("geoBox");else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,a){s.cancel(e);var r=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,c=o.msg.now_geo.weather.code,x=o.msg.now_geo.weather.isNight;last_weather=l.getGeoWeatherType(r,g),now_weather=l.getGeoWeatherType(c,x),t.geoBox=o.msg,t.geoBox.distance=l.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=u.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage&&t.toggleCurrentPage("geoBox"),s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){f("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){f("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o&&(t.isLoadErr=!0)})})}else"infoBox"===t.currentPage&&t.toggleCurrentPage("geoBox")},t.atUser=[],t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(e,o){var s=e.match(/\@([^\s\@]){1,16}/g);if(s&&s!==t.atUser){for(var n=s.length,i=0;n>i;i++)t.atUser.indexOf(s[i])<0&&t.atUser.push(s[i]);for(var a=t.atUser.length,i=0;a>i;i++)s.indexOf(t.atUser[i])<0&&t.atUser.splice(i,1)}else t.atUser=[]}),t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1},e.socket?B():h(),"geoServices"===g.get("nextStep")&&(t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices(),g.remove("nextStep"))}]);

...
angular.module("ShinyaApp.usercountDirective",[]).directive("syUsercount",function(){return{restrict:"E",template:'<div ng-if="!isMobile" id="userCount" ng-click="toggleAtUserBox()">在線人數：{{userCount}}</div>',controller:["$scope",function(n){n.userCount=0,n.onlineUser=[],n.onUserIO=function(e){n.$apply(function(){n.userCount=e.count,n.onlineUser=e.onlineUser})}}]}});

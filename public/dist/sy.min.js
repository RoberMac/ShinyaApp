...
angular.module("ShinyaApp.timeHelperServices",[]).service("syTimeHelper",function(){this.partsOfADay=function(t){return 3>=t?"深夜":6>=t?"破曉":9>=t?"早晨":12>=t?"午前":15>=t?"午後":18>=t?"傍晚":21>=t?"薄暮":"深夜"},this.getNumero=function(t){return 77>t?"gold":177>t?"aluminum":"steel"},this.getDaytimeOrNight=function(t){return t>6&&18>t?"daytime":"night"},this.getTodayMs=function(t){var t=new Date(t);return Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate())},this.isSameDay=function(t,e){return this.getTodayMs(t)===this.getTodayMs(e)}});
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,r,a,g,c,l,u,m){function x(e){var n=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:t.timezoneOffset}).success(function(t,o,i,r){s.cancel(n),e("ok",t.msg)}).error(function(o,i,r,a){401===i?t.quit():(400===i?s.cancel(n):null,e("error",o.msg||"網絡出錯，請稍候再試"))})}function f(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function d(o){var s=e.socket.id===o.id,n=c.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:m.isShowDate(o.date),date:o.date,msg:m.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0?t.img_list[o.date]=m.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?c.scrollToPos():o.at&&o.at.indexOf("@"+p.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function h(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:p.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:m.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=m.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){d(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function w(){e.socket=io("",{query:"token="+S,secure:!0}),h()}function B(){e.socket.disconnect(),e.socket.connect("",{query:"token="+S,secure:!0}),h()}e.isSubmit=!1,t.isChatBox=!0,t.isSun="daytime"===l.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isInfoBox=!1,t.toggleChatBox=function(e){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun),t.now_img_list=[],t.isZoomIn=!1},t.currentPage="infoBox",t.toggleCurrentPage=function(e){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),s(function(){t.currentPage=e})};var S=g.get("id_token"),p=a.decodeToken(S);t.infoBox={title:"加入於",username:p.username,numero:p.numero,date:r("date")(p.date,"yyyy 年 M 月 d 日"),country:p.country,partsOfADay:l.partsOfADay(~~r("date")(p.date,"H")),weather:p.weather.description},t.numero=l.getNumero(t.infoBox.numero),t.getDaytimeOrNight=l.getDaytimeOrNight(~~r("date")(p.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==u.getCityWeatherType(p.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=u.getCityWeatherType(p.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.selectDateNewsBox=[],t.timezoneOffset=(new Date).getTimezoneOffset()/60,t.selectDate=(new Date).getHours(),t.selectCountry=t.infoBox.country||"US",t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",t.getSelectedDateNews()},t.getSelectedDateNews=function(){var e=l.getTodayMs(p.date)+t.selectCountry+t.selectDate,o=g.get(e);o?(t.selectDateNewsBox=o,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),x(function(o,s){"ok"===o?(g.set(e,s),t.selectDateNewsBox=s,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=s,t.isNewsExist?t.toggleNewsExist():null)}))},t.previousHour=function(){t.selectDate>1?(t.selectDate--,t.getSelectedDateNews()):(t.selectDate=24,t.getSelectedDateNews())},t.nextHour=function(){t.selectDate<24?(t.selectDate++,t.getSelectedDateNews()):(t.selectDate=1,t.getSelectedDateNews())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||p.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(e,o,s,n){"on"===e.msg?(g.set("isGeoServices",!0),g.set("nextStep","geoServices"),t.$emit("preTurnOnGeoServices","已開啟服務，請重新登錄")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","已關閉服務，請重新登錄")),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,r){s.cancel(e);var a=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,c=o.msg.now_geo.weather.code,m=o.msg.now_geo.weather.isNight;last_weather=u.getGeoWeatherType(a,g),now_weather=u.getGeoWeatherType(c,m),t.geoBox=o.msg,t.geoBox.distance=u.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=l.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){f("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){f("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(e,o){var s=e.match(/\@([^\s\@]){1,16}/g);if(s&&s!==t.atUser){for(var n=s.length,i=0;n>i;i++)t.atUser.indexOf(s[i])<0?t.atUser.push(s[i]):null;for(var r=t.atUser.length,i=0;r>i;i++)s.indexOf(t.atUser[i])<0?t.atUser.splice(i,1):null}else t.atUser=[]}),t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1},e.socket?B():w(),"geoServices"===g.get("nextStep")&&(t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices(),g.remove("nextStep"))}]);

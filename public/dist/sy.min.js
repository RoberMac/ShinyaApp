angular.module("ShinyaApp",["ngRoute","ngTouch","ngAnimate","angular-jwt","angular-storage","ShinyaApp.posHelperServices","ShinyaApp.timeHelperServices","ShinyaApp.geoHelperServices","ShinyaApp.msgHelperServices","ShinyaApp.logoDirective","ShinyaApp.notifyDirective","ShinyaApp.autofocusDirective","ShinyaApp.hideKeyboardDirective","ShinyaApp.imageonloadDirective","ShinyaApp.autoscrollDirective","ShinyaApp.imgDirective","ShinyaApp.beepDirective","ShinyaApp.usercountDirective","ShinyaApp.submitController","ShinyaApp.chatController","ShinyaApp.forgotController","duScroll"]).config(["$routeProvider","$locationProvider","$httpProvider","jwtInterceptorProvider",function(e,t,o,i){t.html5Mode(!0),e.when("/",{templateUrl:"/public/dist/submit.min.html",controller:"submitController"}).when("/chat",{templateUrl:"/public/dist/chat.min.html",controller:"chatController"}).when("/forgot",{templateUrl:"/public/dist/forgot.min.html",controller:"forgotController"}).otherwise({redirectTo:"/"}),i.tokenGetter=["store",function(e){return e.get("id_token")}],o.interceptors.push("jwtInterceptor")}]).controller("rootController",["$rootScope","$scope","$timeout","$location","$route","$window","jwtHelper","store",function(e,t,o,i,r,n,a,c){function l(){var e=n.navigator.userAgent;return e.match(/Android/i)||e.match(/webOS/i)||e.match(/iPhone/i)||e.match(/iPad/i)||e.match(/iPod/i)||e.match(/BlackBerry/i)||e.match(/Windows Phone/i)?!0:!1}t.isLogoLoaded=!1,e.isSubmit=!0,e.lastInfo=[],e.isMobile=l(),!n.navigator.standalone&&e.isMobile,t.$on("$routeChangeStart",function(e,t,o,r){var n=c.get("id_token");"/"===i.path()?n?a.isTokenExpired(n)?null:i.path("/chat").replace():null:"/chat"===i.path()&&(!n||a.isTokenExpired(n)?i.path("/").replace():null)}),t.$on("preTurnOnGeoServices",function(e){o(function(){t.$broadcast("turnOnGeoServices",e)},100)}),t.$on("preTurnOffGeoServices",function(e){o(function(){t.$broadcast("turnOffGeoServices",e)},100)})}]);
...
angular.module("ShinyaApp.timeHelperServices",[]).service("syTimeHelper",function(){this.partsOfADay=function(t){return 3>=t?"深夜":6>=t?"破曉":9>=t?"早晨":12>=t?"午前":15>=t?"午後":18>=t?"傍晚":21>=t?"薄暮":"深夜"},this.getNumero=function(t){return 77>t?"gold":177>t?"aluminum":"steel"},this.getDaytimeOrNight=function(t){return t>6&&18>t?"daytime":"night"},this.getDayMs=function(t){var t=new Date(t);return Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate())},this.isSameDay=function(t,e){return this.getDayMs(t)===this.getDayMs(e)}});
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,r,a,g,u,l,c,w){function f(){t.isTodayNews=!1,t.isShowNewsOptions=!1,t.isOtherDateNews=!1}function m(){var e,o;1===t.selectDate?(e=24,o=t.selectDate+1):24===t.selectDate?(e=23,o=1):(e=t.selectDate-1,o=t.selectDate+1),t.isShowPreHour=t.isTodayNews&&e>(new Date).getHours()?!1:!0,t.isShowNextHour=t.isTodayNews&&o>(new Date).getHours()?!1:!0}function d(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function x(o){var s=e.socket.id===o.id,n=u.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:w.isShowDate(o.date),date:o.date,msg:w.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0?t.img_list[o.date]=w.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?u.scrollToPos():o.at&&o.at.indexOf("@"+N.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function h(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:N.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:w.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=w.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){x(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function B(){e.socket=io("",{query:"token="+S,secure:!0}),h()}function y(){e.socket.disconnect(),e.socket.connect("",{query:"token="+S,secure:!0}),h()}function D(){for(var e=n.localStorage,t=localStorage.length,o=/^one-day-news-/,s=0,i=0;t>i;i++)o.test(e.key(s))?g.remove(e.key(s)):s++}e.isSubmit=!1,t.isSun="daytime"===l.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isChatBox=!0,t.isInfoBox=!1,t.isShowNewsOptions=!1,t.isLoadErr=!1,t.toggleChatBox=function(e,o){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox,o?f():null):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,o?f():null),t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1},t.currentPage="infoBox",t.currentPageIs=function(e){return t.currentPage===e},t.toggleCurrentPage=function(e,o){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),o?f():null,s(function(){t.currentPage=e})};var S=g.get("id_token"),N=a.decodeToken(S);t.infoBox={title:"加入於",username:N.username,numero:N.numero,date:r("date")(N.date,"yyyy 年 M 月 d 日"),country:N.country,partsOfADay:l.partsOfADay(~~r("date")(N.date,"H")),weather:N.weather.description},t.numero=function(e){return l.getNumero(t.infoBox.numero)},t.getDaytimeOrNight=l.getDaytimeOrNight(~~r("date")(N.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==c.getCityWeatherType(N.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=c.getCityWeatherType(N.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.otherUserInfo={},t.otherUserInfoId=0,t.isOtherDateNews=!1,t.toggleOtherUserInfo=function(e,s){return s===t.otherUserInfoId?void(t.otherUserInfoId=0):void(g.get(e)?(t.otherUserInfo=g.get(e),t.otherUserInfoId=s):o.post("/api/getUserInfo",{username:e}).success(function(o,n,i,a){var u={username:e,numero:o.msg.numero,country:o.msg.country||"CN",date:r("date")(o.msg.date,"yyyy 年 M 月 d 日"),pure_date:o.msg.date};g.set(e,u),t.otherUserInfo=u,t.otherUserInfoId=s}).error(function(e,t,o,s){}))},t.getOtherDateNews=function(e){t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.isTodayNews=!1,t.isOtherDateNews=!0,t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1,t.selectDate=(new Date).getHours(),m(),t.getSelectedDateNews(e,t.otherUserInfo.pure_date,!0)},t.isTodayNews=!1,t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.newsDateTitle="當日新聞",t.selectDateNewsBox=[],t.selectDate=(new Date).getHours(),t.selectCountry=t.infoBox.country||"CN";var p=(new Date).getTimezoneOffset()/60,v=g.getNamespacedStore("one-day-news","-"),C=function(e,n){var i=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{username:n,selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:p,isTodayNews:t.isTodayNews}).success(function(t,o,n,r){s.cancel(i),e("ok",t.msg)}).error(function(o,n,r,a){401===n?t.quit():(400===n?s.cancel(i):null,e("error",o.msg||"網絡出錯，請稍候再試"))})},_=function(e,t){v.set(e,t);var o=Date.now()+864e5;g.set("oneDayNewsExpires",l.getDayMs(o))},I=function(){t.isOtherDateNews?t.getSelectedDateNews(t.otherUserInfo.username,t.otherUserInfo.pure_date,!0):t.isTodayNews?t.getSelectedDateNews(null,Date.now(),!0):t.getSelectedDateNews(null,N.date)};t.toggleTodayNews=function(){t.isTodayNews?(t.isTodayNews=!1,t.selectDate=(new Date).getHours(),m(),t.getSelectedDateNews(null,N.date)):(t.isTodayNews=!0,t.selectDate=(new Date).getHours(),m(),t.getSelectedDateNews(null,Date.now(),!0))},t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",I()},t.getSelectedDateNews=function(e,o,s){var e=e||N.username,o=o||Date.now(),s=s||!1,n=l.getDayMs(o)+t.selectCountry+t.selectDate,i=s?v.get(n):g.get(n);t.isShowNewsOptions=!0,t.newsDateTitle=t.isTodayNews?"今日新聞":"當日新聞",t.isLoadErr=!1,i?(t.selectDateNewsBox=i,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),C(function(e,o){"ok"===e?(t.isNewsExist?null:t.toggleNewsExist(),o?s?_(n,o):g.set(n,o):t.isNewsExist?t.toggleNewsExist():null,t.selectDateNewsBox=o,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=o,t.isNewsExist?t.toggleNewsExist():null)},e))},t.isShowPreHour=!0,t.isShowNextHour=!0,t.preHour=function(){t.isShowPreHour&&(t.selectDate>1?(t.selectDate--,I()):(t.selectDate=24,I()),m())},t.nextHour=function(){t.isShowNextHour&&(t.selectDate<24?(t.selectDate++,I()):(t.selectDate=1,I()),m())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),e.lastInfo[0]=N.username,t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||N.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(o,s,n,i){"on"===o.msg?(g.set("isGeoServices",!0),e.lastInfo[1]="gotoGeoBox",t.$emit("preTurnOnGeoServices","已開啟服務，請重新登錄")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","已關閉服務，請重新登錄")),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,r){s.cancel(e);var a=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,u=o.msg.now_geo.weather.code,w=o.msg.now_geo.weather.isNight;last_weather=c.getGeoWeatherType(a,g),now_weather=c.getGeoWeatherType(u,w),t.geoBox=o.msg,t.geoBox.distance=c.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=l.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){d("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){d("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isShowAtUserBox=!1,t.toggleAtUserBox=function(){t.isShowAtUserBox=!t.isShowAtUserBox},t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(o,s){var n=o.match(/\@([^\s\@]){1,16}/g);if(n&&n!==t.atUser){for(var i=n.length,r=0;i>r;r++)t.atUser.indexOf(n[r])<0?t.atUser.push(n[r]):null;for(var a=t.atUser.length,r=0;a>r;r++)n.indexOf(t.atUser[r])<0?t.atUser.splice(r,1):null}else t.atUser=[];o.match(/\@$/g)&&(t.isShowAtUserBox=!0,e.isMobile?document.getElementById("chat_submit_input").blur():null),(s.match(/\@$/g)||o.match(/\@([^\s\@]){1,16}\s$/g))&&(t.isShowAtUserBox=!1,e.isMobile,document.getElementById("chat_submit_input").focus())}),t.removeAtUser=function(e){var o=new RegExp("\\s?"+e+"\\s?","g");t.msgOutbox.textMsg=t.msgOutbox.textMsg.replace(o,"")},t.addAtUser=function(o){var s=t.msgOutbox.textMsg;s.match(o)?null:t.msgOutbox.textMsg=s.concat(s.match(/\@$/g)?o+" ":"@"+o+" "),e.isMobile||t.isChatBox?null:t.toggleChatBox(null,!0)},t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1,t.isShowAtUserBox=!1},e.socket?y():B();var U=e.lastInfo[0],M=e.lastInfo[1];U&&U!==N.username?(e.lastInfo=[],n.location.reload()):M&&"gotoGeoBox"===M?(e.lastInfo=[],t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices()):e.lastInfo=[],g.get("oneDayNewsExpires")<Date.now()?D():null}]);
angular.module("ShinyaApp.forgotController",[]).controller("forgotController",["$scope","$rootScope","$http","$timeout","$location",function(o,t,r,s,e){t.isSubmit=!1,o.isMsgNotify=!1,o.errMsg="",o.okMsg="",o.msgNotify=function(t,r){"error"===t?(o.input_shake_animate=!0,o.errMsg=r,o.isMsgNotify=!0,s(function(){o.errMsg="",o.input_shake_animate=!1,o.isMsgNotify=!1},1717)):"ok"===t?(o.okMsg=r,o.isMsgNotify=!0,s(function(){o.okMsg="",o.isMsgNotify=!1},1717)):console.error("[TypeError]: Not `error` or `ok`")},o.forgot={},o.step=1,o.returnToPreviousStep=function(){1===o.step?e.path("/"):o.step=o.step-1},o.gotoStepThree=function(){o.step=3,o.msgNotify("ok","請輸入新密碼")},o.forgotEmailSubmit=function(){r.post("/forgot_email",{email:o.forgot.email}).success(function(t,r,s,e){o.step=2,o.msgNotify("ok",t.msg)}).error(function(t,r,s,e){o.msgNotify("error",t.msg)}),o.forgot={}},o.forgotCodeSubmit=function(){r.post("/forgot_code",{code:o.forgot.code,password:o.forgot.password}).success(function(t,r,i,n){o.msgNotify("ok",t.msg),s(function(){e.path("/")},2e3)}).error(function(t,r,e,i){o.msgNotify("error",t.msg),s(function(){o.returnToPreviousStep()},717)}),o.forgot={}}}]);
angular.module("ShinyaApp.submitController",[]).controller("submitController",["$scope","$rootScope","$http","$timeout","$location","$route","$window","jwtHelper","store",function(o,i,t,e,r,s,n,g,u){i.isSubmit=!0,o.isMsgNotify=!1,o.errMsg="",o.okMsg="",o.msgNotify=function(i,t){"error"===i?(o.input_shake_animate=!0,o.errMsg=t,o.isMsgNotify=!0,e(function(){o.errMsg="",o.input_shake_animate=!1,o.isMsgNotify=!1},1717)):"ok"===i?(o.okMsg=t,o.isMsgNotify=!0,e(function(){o.okMsg="",o.isMsgNotify=!1},1717)):console.error("[TypeError]: Not `error` or `ok`")},u.get("id_token")&&g.isTokenExpired(u.get("id_token"))&&e(function(){o.msgNotify("ok","請重新登錄")},0),o.$on("turnOnGeoServices",function(i){e(function(){o.msgNotify("ok","已開啟服務，請重新登錄")},0)}),o.$on("turnOffGeoServices",function(i){e(function(){o.msgNotify("ok","已關閉服務，請重新登錄")},0)}),o.isLogin=!0,o.toggleSubmit=function(){o.isLogin=!o.isLogin},o.login={},o.register={},o.loginSubmit=function(){t.post("/login",{user:o.login.user,password:o.login.password}).success(function(o,i,t,e){u.set("id_token",o.token),r.path("/chat").replace()}).error(function(i,t,e,r){o.msgNotify("error",i.msg)}),o.login={}},o.registerSubmit=function(){t.post("/register",{username:o.register.username,email:angular.lowercase(o.register.email),password:o.register.password}).success(function(i,t,e,r){o.msgNotify("ok",i.msg),o.toggleSubmit()}).error(function(i,t,e,r){o.msgNotify("error",i.msg)}),o.register={}}}]);

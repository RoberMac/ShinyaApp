...
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,r,a,g,u,l,c,d){function f(){t.isTodayNews=!1,t.isShowNewsOptions=!1,t.isOtherDateNews=!1}function w(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function m(o){var s=e.socket.id===o.id,n=u.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:d.isShowDate(o.date),date:o.date,msg:d.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0?t.img_list[o.date]=d.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?u.scrollToPos():o.at&&o.at.indexOf("@"+N.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function x(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:N.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:d.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=d.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){m(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function h(){e.socket=io("",{query:"token="+p,secure:!0}),x()}function y(){e.socket.disconnect(),e.socket.connect("",{query:"token="+p,secure:!0}),x()}function B(){for(var e=n.localStorage,t=localStorage.length,o=/^one-day-news-/,s=0,i=0;t>i;i++)o.test(e.key(s))?g.remove(e.key(s)):s++}e.isSubmit=!1,t.isSun="daytime"===l.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isChatBox=!0,t.isInfoBox=!1,t.isShowNewsOptions=!1,t.isLoadErr=!1,t.toggleChatBox=function(e,o){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox,o?f():null):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,o?f():null),t.now_img_list=[],t.isZoomIn=!1},t.currentPage="infoBox",t.currentPageIs=function(e){return t.currentPage===e},t.toggleCurrentPage=function(e,o){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),o?f():null,s(function(){t.currentPage=e})};var p=g.get("id_token"),N=a.decodeToken(p);t.infoBox={title:"加入於",username:N.username,numero:N.numero,date:r("date")(N.date,"yyyy 年 M 月 d 日"),country:N.country,partsOfADay:l.partsOfADay(~~r("date")(N.date,"H")),weather:N.weather.description},t.numero=function(e){return l.getNumero(t.infoBox.numero)},t.getDaytimeOrNight=l.getDaytimeOrNight(~~r("date")(N.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==c.getCityWeatherType(N.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=c.getCityWeatherType(N.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.otherUserInfo={},t.otherUserInfoId=0,t.isOtherDateNews=!1,t.toggleOtherUserInfo=function(e,s){return s===t.otherUserInfoId?void(t.otherUserInfoId=0):void(g.get(e)?(t.otherUserInfo=g.get(e),t.otherUserInfoId=s):o.post("/api/getUserInfo",{username:e}).success(function(o,n,i,a){var u={username:e,numero:o.msg.numero,country:o.msg.country||"CN",date:r("date")(o.msg.date,"yyyy 年 M 月 d 日"),pure_date:o.msg.date};g.set(e,u),t.otherUserInfo=u,t.otherUserInfoId=s}).error(function(e,t,o,s){}))},t.getOtherDateNews=function(e){t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.isTodayNews=!1,t.isOtherDateNews=!0,t.getSelectedDateNews(e,t.otherUserInfo.pure_date,!0)},t.isTodayNews=!1,t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.newsDateTitle="當日新聞",t.selectDateNewsBox=[],t.selectDate=(new Date).getHours(),t.selectCountry=t.infoBox.country||"CN";var S=(new Date).getTimezoneOffset()/60,D=g.getNamespacedStore("one-day-news","-"),v=function(e,n){var i=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{username:n,selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:S,isTodayNews:t.isTodayNews}).success(function(t,o,n,r){s.cancel(i),e("ok",t.msg)}).error(function(o,n,r,a){401===n?t.quit():(400===n?s.cancel(i):null,e("error",o.msg||"網絡出錯，請稍候再試"))})},C=function(e,t){D.set(e,t);var o=Date.now()+864e5;g.set("oneDayNewsExpires",l.getDayMs(o))},_=function(){t.isOtherDateNews?t.getSelectedDateNews(t.otherUserInfo.username,t.otherUserInfo.pure_date,!0):t.isTodayNews?t.getSelectedDateNews(null,Date.now(),!0):t.getSelectedDateNews(null,N.date)};t.toggleTodayNews=function(){t.isTodayNews?(t.isTodayNews=!1,t.getSelectedDateNews(null,N.date)):(t.isTodayNews=!0,t.getSelectedDateNews(null,Date.now(),!0))},t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",_()},t.getSelectedDateNews=function(e,o,s){var e=e||N.username,o=o||Date.now(),s=s||!1,n=l.getDayMs(o)+t.selectCountry+t.selectDate,i=s?D.get(n):g.get(n);t.isShowNewsOptions=!0,t.newsDateTitle=t.isTodayNews?"今日新聞":"當日新聞",t.isLoadErr=!1,i?(t.selectDateNewsBox=i,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),v(function(e,o){"ok"===e?(t.isNewsExist?null:t.toggleNewsExist(),o?s?C(n,o):g.set(n,o):t.isNewsExist?t.toggleNewsExist():null,t.selectDateNewsBox=o,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=o,t.isNewsExist?t.toggleNewsExist():null)},e))},t.previousHour=function(){t.selectDate>1?(t.selectDate--,_()):(t.selectDate=24,_())},t.nextHour=function(){t.selectDate<24?(t.selectDate++,_()):(t.selectDate=1,_())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||N.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(e,o,s,n){"on"===e.msg?(g.set("isGeoServices",!0),g.set("nextStep","geoServices"),t.$emit("preTurnOnGeoServices","已開啟服務，請重新登錄")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","已關閉服務，請重新登錄")),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,r){s.cancel(e);var a=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,u=o.msg.now_geo.weather.code,d=o.msg.now_geo.weather.isNight;last_weather=c.getGeoWeatherType(a,g),now_weather=c.getGeoWeatherType(u,d),t.geoBox=o.msg,t.geoBox.distance=c.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=l.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){w("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){w("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(e,o){var s=e.match(/\@([^\s\@]){1,16}/g);if(s&&s!==t.atUser){for(var n=s.length,i=0;n>i;i++)t.atUser.indexOf(s[i])<0?t.atUser.push(s[i]):null;for(var r=t.atUser.length,i=0;r>i;i++)s.indexOf(t.atUser[i])<0?t.atUser.splice(i,1):null}else t.atUser=[]}),t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1},e.socket?y():h(),"geoServices"===g.get("nextStep")&&(t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices(),g.remove("nextStep")),g.get("oneDayNewsExpires")<Date.now()?B():null}]);

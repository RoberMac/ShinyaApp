...
function urlSanitization(t){var e=document.createElement("a");return e.href=t,e.hostname}angular.module("ShinyaApp.textMsgDirective",[]).directive("syTextMsg",["$compile",function(t){return{restrict:"A",scope:{contentItem:"=item",imgClick:"&"},link:function(e,n,a){for(var i=e.contentItem.msg,r=e.contentItem.img_list,c=r.length,l=e.contentItem.url_list,m=l.length,s=0;c>s;s++)i=i.replace(r[s],'<span class="img_item faster_animate" ng-click="imgClick({contentItem: contentItem, index: '+s+'})"></span>');for(var s=0;m>s;s++){var o=urlSanitization(l[s]);i=i.replace(l[s],'<span class="url_item faster_animate"><a class="faster_animate" href="'+l[s]+'" target="_blank">'+o+"</a></span>")}n.html(i),t(n.contents())(e)}}}]);

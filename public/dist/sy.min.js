...
angular.module("ShinyaApp.i18nDirective",[]).directive("syI18n",function(){return{restrict:"E",replace:!0,template:'<div id="i18n" class="bottom_left_corner general_animate"><div ng-repeat="item in langList" class="lang country general_animate general_box_shadow" ng-class="item.country" ng-click="changeLanguage(item.country)">{{item.lang}}</div></div>',controller:["$scope","$rootScope","$timeout","$translate","store",function(n,t,e,a,l){function g(){for(var t=0;t<o.length;t++){var e=n.langList,a=e.length-1;e[a].lang!==o[t].lang?e.unshift(o[t]):null,n.langList=e}}function r(){for(var t=0;t<o.length;t++){var e=n.langList,a=e.length-1;e[a].lang!==o[t].lang?e.shift(o[t]):null,n.langList=e}}var i=["HK","CN","TW","US","JP","KR"],o=[{lang:"繁",country:"HK",key:"zh-HK"},{lang:"简",country:"CN",key:"zh-CN"},{lang:"正",country:"TW",key:"zh-TW"},{lang:"EN",country:"US",key:"en"},{lang:"日",country:"JP",key:"ja"},{lang:"한",country:"KR",key:"ko"}],c=l.get("NG_TRANSLATE_COUNTRY")||"HK",u=i.indexOf(c),s=o[u].lang;n.langList=[{lang:s,country:c}],n.changeLanguage=function(c){var u=n.langList.length,s=i.indexOf(c);c===n.langList[u-1].country?o.length===u?r():g():(t.$broadcast("$translateChangeBeforeStart"),e(function(){l.set("NG_TRANSLATE_COUNTRY",o[s].country),a.use(o[s].key)},1e3))}}]}});

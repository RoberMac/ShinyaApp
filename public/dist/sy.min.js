...
function urlSanitization(e){for(var t={"zhihu.com":"知乎","weibo.com":"微博","douban.com":"豆瓣","weixin.qq.com":"微信","taobao.com":"淘宝","tmall.com":"天猫","etao.com":"一淘","jd.com":"京东","amazon.cn":"亚马逊中国","suning.com":"苏宁易购","yixun.com":"易迅网","meituan.com":"美团","apple.com":"Apple","youku.com":"优酷","tudou.com":"土豆","iqiyi.com":"爱奇艺","tv.sohu.com":"搜狐视频","letv.com":"乐视","bilibili.com":"哔哩哔哩","acfun.tv":"AcFun","cntv.cn":"央视网","v.qq.com":"腾讯视频","qq.com":"腾讯","163.com":"网易","sohu.com":"搜狐","sina.com.cn":"新浪","people.com.cn":"人民网","xinhuanet.com":"新华网","ifeng.com":"鳳凰網","58.com":"58 同城","ganji.com":"赶集","dxy.cn":"丁香园","hupu.com":"虎扑体育"},n=Object.keys(t),c=n.length,o=0;c>o;o++)if(e.indexOf(n[o])>=0)return t[n[o]];var m=document.createElement("a"),i=/(?:\w*\.)?(\w+)(?=\.(\w)+)/g;m.href=e;try{return i.exec(m.hostname)[1].toUpperCase()}catch(a){return"❓"}}angular.module("ShinyaApp.textMsgDirective",[]).directive("syTextMsg",["$compile",function(e){return{restrict:"A",scope:{contentItem:"=item",imgClick:"&"},link:function(t,n,c){for(var o=t.contentItem.msg,m=t.contentItem.img_list,i=m.length,a=t.contentItem.url_list,r=a.length,l=0;i>l;l++)o=o.replace(m[l],'<span class="img_item faster_animate" ng-click="imgClick({contentItem: contentItem, index: '+l+'})"></span>');for(var l=0;r>l;l++){var u=urlSanitization(a[l]);o=o.replace(new RegExp(a[l]+'(?!")'),'<span class="url_item faster_animate"><a class="faster_animate" href="'+a[l]+'" target="_blank">'+u+"</a></span>")}n.html(o),e(n.contents())(t)}}}]);

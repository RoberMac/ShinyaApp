...
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,a,r,g,c,u,l,x){function m(e){o.post("/api/getSelectedDateNews",{selectDate:t.selectDate,timezoneOffset:t.timezoneOffset}).success(function(t,o,s,n){e("ok",t.msg)}).error(function(o,s,n,i){401===s?t.quit():e("error",o.msg||"網絡出錯，請稍候再試")})}function f(o){var s=e.socket.id===o.id,n=c.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:x.isShowDate(o.date),date:o.date,msg:x.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0&&(t.img_list[o.date]=x.imgSanitization(o.img_list))}),(n||s)&&t.isChatBox?c.scrollToPos():o.at&&o.at.indexOf("@"+p.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function d(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:p.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:x.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0&&(t.img_list[e[s].date]=x.imgSanitization(e[s].img_list))})})}),e.socket.on("textMsg",function(e){f(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function w(){e.socket=io(":8080",{query:"token="+B}),d()}function h(){console.log("reconnect"),e.socket.disconnect(),e.socket.connect(":8080"),d()}e.isSubmit=!1,t.isChatBox=!0,t.isSun="daytime"===u.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isInfoBox=!1,t.toggleChatBox=function(e){e?"left"===e?t.isChatBox&&(t.isChatBox=!t.isChatBox):"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox):(t.isChatBox||t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun),t.now_img_list=[],t.isZoomIn=!1},t.currentPage="infoBox",t.toggleCurrentPage=function(e){s(function(){t.currentPage=e})};var B=g.get("id_token"),p=r.decodeToken(B);console.log(p),t.infoBox={title:"加入於",username:p.username,numero:p.numero,date:a("date")(p.date,"yyyy 年 M 月 d 日"),partsOfADay:u.partsOfADay(~~a("date")(p.date,"H")),weather:p.weather.description},t.numero=u.getNumero(t.infoBox.numero),t.getDaytimeOrNight=u.getDaytimeOrNight(~~a("date")(p.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==l.getCityWeatherType(p.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=l.getCityWeatherType(p.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.newsBox={},t.selectDateNewsBox=[],t.timezoneOffset=(new Date).getTimezoneOffset()/60,t.selectDate=(new Date).getHours(),t.getSelectedDateNews=function(){t.selectDate in t.newsBox?(t.selectDateNewsBox=t.newsBox[t.selectDate],"infoBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.isNewsExist||t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),m(function(e,o){"ok"===e?(t.newsBox[t.selectDate]=o,t.selectDateNewsBox=t.newsBox[t.selectDate],"loadBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.isNewsExist||t.toggleNewsExist()):("loadBox"===t.currentPage&&t.toggleCurrentPage("newsBox"),t.newsErrMsg=o,t.isNewsExist&&t.toggleNewsExist())}))},t.previousHour=function(){t.selectDate>1?(t.selectDate--,t.getSelectedDateNews()):(t.selectDate=24,t.getSelectedDateNews())},t.nextHour=function(){t.selectDate<24?(t.selectDate++,t.getSelectedDateNews()):(t.selectDate=1,t.getSelectedDateNews())},t.gotoSettingBox=function(){"infoBox"===t.currentPage&&t.toggleCurrentPage("settingBox")},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||p.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(e,o,s,n){"on"===e.msg?(g.set("isGeoServices",!0),t.$emit("preTurnOnGeoServices","驗證身份以開啟服務")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","驗證身份以關閉服務")),t.quit()}).error(function(e,o,s,n){401===o?t.quit():404===o&&(t.isLoadErr=!0)})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){t.isGeoServices?t.geoBox.distance?"infoBox"===t.currentPage&&t.toggleCurrentPage("geoBox"):("infoBox"===t.currentPage&&(t.toggleCurrentPage("loadBox"),t.isLoadErr=!1),n.navigator.geolocation.getCurrentPosition(function(e){console.log(e.coords.latitude,e.coords.longitude),o.post("/api/getGeoServices",{coords:{lat:e.coords.latitude,lon:e.coords.longitude}}).success(function(e,o,s,n){var i=e.msg.last_geo.weather.code,a=e.msg.last_geo.weather.isNight,r=e.msg.now_geo.weather.code,g=e.msg.now_geo.weather.isNight;last_weather=l.getGeoWeatherType(i,a),now_weather=l.getGeoWeatherType(r,g),t.geoBox=e.msg,t.geoBox.distance=l.getDistance(e.msg.last_geo,e.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=u.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage&&t.toggleCurrentPage("geoBox")}).error(function(e,o,s,n){401===o&&t.quit()})})):"infoBox"===t.currentPage&&t.toggleCurrentPage("geoBox")},t.atUser=[],t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(e,o){var s=e.match(/\@([^\s\@]){1,16}/g);if(s&&s!==t.atUser){for(var n=s.length,i=0;n>i;i++)t.atUser.indexOf(s[i])<0&&t.atUser.push(s[i]);for(var a=t.atUser.length,i=0;a>i;i++)s.indexOf(t.atUser[i])<0&&t.atUser.splice(i,1)}else t.atUser=[]}),t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1},e.socket?h():w()}]);

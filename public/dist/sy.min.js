angular.module("ShinyaApp",["ngRoute","ngTouch","ngAnimate","angular-jwt","angular-storage","duScroll","pascalprecht.translate","ShinyaApp.posHelperServices","ShinyaApp.timeHelperServices","ShinyaApp.geoHelperServices","ShinyaApp.msgHelperServices","ShinyaApp.logoDirective","ShinyaApp.notifyDirective","ShinyaApp.autofocusDirective","ShinyaApp.hideKeyboardDirective","ShinyaApp.imageonloadDirective","ShinyaApp.autoscrollDirective","ShinyaApp.imgDirective","ShinyaApp.beepDirective","ShinyaApp.usercountDirective","ShinyaApp.i18nDirective","ShinyaApp.textMsgDirective","ShinyaApp.submitController","ShinyaApp.chatController","ShinyaApp.forgotController"]).config(["$routeProvider","$locationProvider","$httpProvider","jwtInterceptorProvider","$translateProvider",function(e,t,r,i,o){t.html5Mode(!0),e.when("/",{templateUrl:"/public/dist/submit.min.html",controller:"submitController"}).when("/chat",{templateUrl:"/public/dist/chat.min.html",controller:"chatController"}).when("/forgot",{templateUrl:"/public/dist/forgot.min.html",controller:"forgotController"}).otherwise({redirectTo:"/"}),i.tokenGetter=["store",function(e){return e.get("id_token")}],r.interceptors.push("jwtInterceptor"),o.useStaticFilesLoader({prefix:"/public/i18n/i18n-",suffix:".json"}).preferredLanguage("zh-HK").useStorage("a0-angular-storage")}]).factory("a0-angular-storage",["store",function(e){return{put:function(t,r){e.set(t,r)},get:function(t){return e.get(t)}}}]).controller("rootController",["$rootScope","$scope","$timeout","$location","$route","$window","jwtHelper","store",function(e,t,r,i,o,n,a,l){function p(){var e=n.navigator.userAgent;return e.match(/Android/i)||e.match(/webOS/i)||e.match(/iPhone/i)||e.match(/iPad/i)||e.match(/iPod/i)||e.match(/BlackBerry/i)||e.match(/Windows Phone/i)?!0:!1}t.isLogoLoaded=!1,e.isSubmit=!0,e.lastInfo=[],e.isMobile=p(),!n.navigator.standalone&&e.isMobile,t.$on("$routeChangeStart",function(e,t,r,o){var n=l.get("id_token");"/"===i.path()?n?a.isTokenExpired(n)?null:i.path("/chat").replace():null:"/chat"===i.path()&&(!n||a.isTokenExpired(n)?i.path("/").replace():null)})}]);
...
angular.module("ShinyaApp.i18nDirective",[]).directive("syI18n",function(){return{restrict:"E",replace:!0,template:'<div id="i18n" class="bottom_left_corner general_animate"><div ng-repeat="item in langList" class="lang country general_animate general_box_shadow" ng-class="item.country" ng-click="changeLanguage(item.country)">{{item.lang}}</div></div>',controller:["$scope","$rootScope","$timeout","$translate","store",function(n,t,e,a,l){function r(){for(var t=0;t<i.length;t++){var e=n.langList,a=e.length-1;e[a].lang!==i[t].lang?e.unshift(i[t]):null,n.langList=e}}function g(){for(var t=0;t<i.length;t++){var e=n.langList,a=e.length-1;e[a].lang!==i[t].lang?e.shift(i[t]):null,n.langList=e}}var o=["HK","CN","JP","TW","US","BR","IN","KR","RU","DE","FR"],i=[{lang:"繁",country:"HK",key:"zh-HK"},{lang:"简",country:"CN",key:"zh-CN"},{lang:"日",country:"JP",key:"ja"},{lang:"正",country:"TW",key:"zh-TW"},{lang:"EN",country:"US",key:"en"},{lang:"Pt",country:"BR",key:"pt"},{lang:"हिंदी",country:"IN",key:"hi"},{lang:"한",country:"KR",key:"ko"},{lang:"Я",country:"RU",key:"ru"},{lang:"DE",country:"DE",key:"de"},{lang:"FR",country:"FR",key:"fr"}],c=l.get("NG_TRANSLATE_COUNTRY")||"HK",u=o.indexOf(c),y=i[u].lang;n.langList=[{lang:y,country:c}],n.changeLanguage=function(c){var u=n.langList.length,y=o.indexOf(c);c===n.langList[u-1].country?i.length===u?g():r():(t.$broadcast("$translateChangeBeforeStart"),e(function(){l.set("NG_TRANSLATE_COUNTRY",i[y].country),a.use(i[y].key)},1e3))}}]}});
...
function urlSanitization(e){for(var t={"zhihu.com":"知乎","weibo.com":"微博","douban.com":"豆瓣","weixin.qq.com":"微信","taobao.com":"淘宝","tmall.com":"天猫","etao.com":"一淘","jd.com":"京东","amazon.cn":"亚马逊中国","suning.com":"苏宁易购","yixun.com":"易迅网","meituan.com":"美团","apple.com":"Apple","youku.com":"优酷","tudou.com":"土豆","iqiyi.com":"爱奇艺","tv.sohu.com":"搜狐视频","letv.com":"乐视","bilibili.com":"哔哩哔哩","acfun.tv":"AcFun","cntv.cn":"央视网","v.qq.com":"腾讯视频","qq.com":"腾讯","163.com":"网易","sohu.com":"搜狐","sina.com.cn":"新浪","people.com.cn":"人民网","xinhuanet.com":"新华网","ifeng.com":"鳳凰網","58.com":"58 同城","ganji.com":"赶集","dxy.cn":"丁香园","hupu.com":"虎扑体育","shenyepoxiao.com":"深夜，破曉。"},n=Object.keys(t),c=n.length,o=0;c>o;o++)if(e.indexOf(n[o])>=0)return t[n[o]];var m=document.createElement("a"),i=/(?:\w*\.)?(\w+)(?=\.(\w)+)/g;m.href=e;try{return i.exec(m.hostname)[1].toUpperCase()}catch(a){return"❓"}}angular.module("ShinyaApp.textMsgDirective",[]).directive("syTextMsg",["$compile",function(e){return{restrict:"A",scope:{contentItem:"=item",imgClick:"&"},link:function(t,n,c){for(var o=t.contentItem.msg,m=t.contentItem.img_list,i=m.length,a=t.contentItem.url_list,r=a.length,l=0;i>l;l++)o=o.replace(m[l],'<span class="img_item faster_animate" ng-click="imgClick({contentItem: contentItem, index: '+l+'})"></span>');for(var l=0;r>l;l++){var s=urlSanitization(a[l]);o=o.replace(new RegExp(a[l]+'(?!")'),'<span class="url_item faster_animate"><a class="faster_animate" href="'+a[l]+'" target="_blank">'+s+"</a></span>")}n.html(o),e(n.contents())(t)}}}]);
...
angular.module("ShinyaApp.msgHelperServices",[]).service("syMsgHelper",function(){function e(e,i){return e.replace(/square|thumbnail|thumb150|bmiddle|mw600|large/,i)}var i=Date.now();this.isShowDate=function(e){return e-i>6e4?(i=Date.now(),!0):!1},this.imgSanitization=function(i){for(var n=[],a=i.length,r=0;a>r;r++)n.push(i[r].indexOf("sinaimg.cn")>=0?{small:e(i[r],"square"),medium:e(i[r],"bmiddle"),large:e(i[r],"large")}:{small:i[r],medium:i[r],large:i[r]});return n}});
...
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","$route","$translate","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,a,r,g,l,u,c,h,w,f){function d(){t.isTodayNews=!1,t.isShowNewsOptions=!1,t.isOtherDateNews=!1}function x(){var e,o;1===t.selectDate?(e=24,o=t.selectDate+1):24===t.selectDate?(e=23,o=1):(e=t.selectDate-1,o=t.selectDate+1),t.isShowPreHour=t.isTodayNews&&e>(new Date).getHours()?!1:!0,t.isShowNextHour=t.isTodayNews&&o>(new Date).getHours()?!1:!0}function m(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function N(o){var s=e.socket.id===o.id,n=c.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,img_list:o.img_list,url_list:o.url_list,isShowDate:f.isShowDate(o.date),date:o.date,msg:o.msg,username:o.username}),o.img_list.length>0?t.img_list[o.date]=f.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?c.scrollToPos():o.at&&o.at.indexOf("@"+C.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function _(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:C.username===e[s].username,isImg:e[s].img_list.length>0,img_list:e[s].img_list,url_list:e[s].url_list,isShowDate:0===s?!0:!1,date:e[s].date,msg:e[s].msg,username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=f.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){N(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function B(){e.socket=io("",{query:"token="+y,secure:!0}),_()}function D(){e.socket.disconnect(),e.socket.connect("",{query:"token="+y,secure:!0}),_()}function S(){for(var e=n.localStorage,t=localStorage.length,o=/^one-day-news-/,s=0,i=0;t>i;i++)o.test(e.key(s))?u.remove(e.key(s)):s++}e.isSubmit=!1,t.isSun="daytime"===h.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isChatBox=!0,t.isInfoBox=!1,t.isShowNewsOptions=!1,t.isLoadErr=!1,t.toggleChatBox=function(e,o){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox,o?d():null):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,o?d():null),t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1},t.currentPage="infoBox",t.currentPageIs=function(e){return t.currentPage===e},t.toggleCurrentPage=function(e,o){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),o?d():null,s(function(){t.currentPage=e})},t.i18n_JOIN=g.instant("chat.JOINED"),t.i18n_DATE_FORMAT=g.instant("chat.DATE_FORMAT"),t.i18n_TIME_FORMAT=g.instant("chat.TIME_FORMAT"),t.$on("$translateChangeBeforeStart",function(){t.isLoadErr=!1,t.toggleCurrentPage("loadBox")}),e.$on("$translateChangeSuccess",function(){r.reload()});var y=u.get("id_token"),C=l.decodeToken(y);t.infoBox={title:g.instant("chat.JOINED"),username:C.username,numero:C.numero,date:a("date")(C.date,t.i18n_DATE_FORMAT),country:C.country,partsOfADay:h.partsOfADay(~~a("date")(C.date,"H")),weather:C.weather.description},t.numero=function(e){return h.getNumero(t.infoBox.numero)},t.getDaytimeOrNight=h.getDaytimeOrNight(~~a("date")(C.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==w.getCityWeatherType(C.weather.code)?(t.partWeather="",t.infoBox.title=g.instant("chat.JOINED")):(t.partWeather=w.getCityWeatherType(C.weather.code),t.infoBox.title=g.instant("chat.THE_DAY_WEATHER"))},t.otherUserInfo={},t.otherUserInfoId=0,t.isOtherDateNews=!1,t.toggleOtherUserInfo=function(e,s){return s===t.otherUserInfoId?void(t.otherUserInfoId=0):void(u.get(e)?(t.otherUserInfo=u.get(e),t.otherUserInfoId=s):o.post("/api/getUserInfo",{username:e}).success(function(o,n,i,a){var r={username:e,numero:o.msg.numero,country:o.msg.country||"CN",date:o.msg.date};u.set(e,r),t.otherUserInfo=r,t.otherUserInfoId=s}).error(function(e,t,o,s){}))},t.getOtherDateNews=function(e){t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.isTodayNews=!1,t.isOtherDateNews=!0,t.now_img_list=[],t.isZoomIn=!1,t.isShowAtUserBox=!1,t.selectDate=(new Date).getHours(),x(),t.getSelectedDateNews(e,t.otherUserInfo.date,!0)},t.isTodayNews=!1,t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg=g.instant("chat.NEWS_NOT_EXIST"),t.newsDateTitle=g.instant("chat.THE_DAY_NEWS"),t.selectDateNewsBox=[],t.selectDate=(new Date).getHours(),t.selectCountry=u.get("NG_TRANSLATE_COUNTRY")||t.infoBox.country||"CN";var p=(new Date).getTimezoneOffset()/60,O=u.getNamespacedStore("one-day-news","-"),E=function(e,n){var i=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{username:n,selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:p,isTodayNews:t.isTodayNews}).success(function(t,o,n,a){s.cancel(i),e("ok",t.msg)}).error(function(o,n,a,r){401===n?t.quit():(400===n?s.cancel(i):null,e("error",o.msg||g.instant("chat.NETWORK_ERROR_MSG")))})},I=function(e,t){O.set(e,t);var o=Date.now()+864e5;u.set("oneDayNewsExpires",h.getDayMs(o))},v=function(){t.isOtherDateNews?t.getSelectedDateNews(t.otherUserInfo.username,t.otherUserInfo.date,!0):t.isTodayNews?t.getSelectedDateNews(null,Date.now(),!0):t.getSelectedDateNews(null,C.date)};t.toggleTodayNews=function(){t.isTodayNews?(t.isTodayNews=!1,t.selectDate=(new Date).getHours(),x(),t.getSelectedDateNews(null,C.date)):(t.isTodayNews=!0,t.selectDate=(new Date).getHours(),x(),t.getSelectedDateNews(null,Date.now(),!0))},t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",v()},t.getSelectedDateNews=function(e,o,s){var e=e||C.username,o=o||Date.now(),s=s||!1,n=h.getDayMs(o)+t.selectCountry+t.selectDate,i=s?O.get(n):u.get(n);t.isShowNewsOptions=!0,t.newsDateTitle=g.instant(t.isTodayNews?"chat.TODAY_NEWS":"chat.THE_DAY_NEWS"),t.isLoadErr=!1,i?(t.selectDateNewsBox=i,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),E(function(e,o){"ok"===e?(t.isNewsExist?null:t.toggleNewsExist(),o?s?I(n,o):u.set(n,o):t.isNewsExist?t.toggleNewsExist():null,t.selectDateNewsBox=o,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=g.instant(o),t.isNewsExist?t.toggleNewsExist():null)},e))},t.isShowPreHour=!0,t.isShowNextHour=!0,t.preHour=function(){t.isShowPreHour&&(t.selectDate>1?(t.selectDate--,v()):(t.selectDate=24,v()),x())},t.nextHour=function(){t.isShowNextHour&&(t.selectDate<24?(t.selectDate++,v()):(t.selectDate=1,v()),x())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!u.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,u.set("isMuted",t.isMuted)},t.quit=function(){u.remove("id_token"),u.remove("isGeoServices"),e.lastInfo[0]=C.username,t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=u.get("isGeoServices")||C.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(o,n,i,a){"on"===o.msg?(u.set("isGeoServices",!0),e.lastInfo[1]="gotoGeoBox",s(function(){e.$broadcast("turnOnGeoServices",g.instant("chat.GEO_ON_MSG"))},100)):(u.set("isGeoServices",!1),s(function(){e.$broadcast("turnOffGeoServices",g.instant("chat.GEO_OFF_MSG"))},100)),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude},countryCode:u.get("NG_TRANSLATE_COUNTRY")||"CN"}).success(function(o,n,i,a){s.cancel(e);var r=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,l=o.msg.now_geo.weather.code,u=o.msg.now_geo.weather.isNight;last_weather=w.getGeoWeatherType(r,g),now_weather=w.getGeoWeatherType(l,u),t.geoBox=o.msg,t.geoBox.distance=w.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=h.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){m("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){m("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isShowAtUserBox=!1,t.toggleAtUserBox=function(){t.isShowAtUserBox=!t.isShowAtUserBox},t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(o,s){var n=o.match(/\@([^\s\@]){1,16}/g);if(n&&n!==t.atUser){for(var i=n.length,a=0;i>a;a++)t.atUser.indexOf(n[a])<0?t.atUser.push(n[a]):null;for(var r=t.atUser.length,a=0;r>a;a++)n.indexOf(t.atUser[a])<0?t.atUser.splice(a,1):null}else t.atUser=[];o.match(/\@$/g)&&(t.isShowAtUserBox=!0,e.isMobile?document.getElementById("chat_submit_input").blur():null),(s.match(/\@$/g)||o.match(/\@([^\s\@]){1,16}\s$/g))&&(t.isShowAtUserBox=!1,e.isMobile,document.getElementById("chat_submit_input").focus())}),t.removeAtUser=function(e){var o=new RegExp("\\s?"+e+"\\s?","g");t.msgOutbox.textMsg=t.msgOutbox.textMsg.replace(o,"")},t.addAtUser=function(o){var s=t.msgOutbox.textMsg;s.match(o)?null:t.msgOutbox.textMsg=s.concat(s.match(/\@$/g)?o+" ":"@"+o+" "),e.isMobile||t.isChatBox?null:t.toggleChatBox(null,!0)},t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1,t.isShowAtUserBox=!1},e.socket?D():B();var T=e.lastInfo[0],M=e.lastInfo[1];T&&T!==C.username?(e.lastInfo=[],n.location.reload()):M&&"gotoGeoBox"===M?(e.lastInfo=[],t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices()):e.lastInfo=[],u.get("oneDayNewsExpires")<Date.now()?S():null}]);

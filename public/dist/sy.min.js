...
angular.module("ShinyaApp.chatController",[]).controller("chatController",["$rootScope","$scope","$http","$timeout","$window","$location","$filter","jwtHelper","store","syPosHelper","syTimeHelper","syGeoHelper","syMsgHelper",function(e,t,o,s,n,i,r,a,g,c,l,u,d){function f(e,t){angular.element(document.getElementById(e)).children().contents().find("path").css({stroke:"inherit",fill:t||"#000"})}function w(o){var s=e.socket.id===o.id,n=c.isBottom(t.isScrollDown)||t.isScrollDown;t.$apply(function(){t.msgInbox.push({isMe:s,isImg:o.img_list.length>0,isShowDate:d.isShowDate(o.date),date:o.date,msg:d.msgSanitization(o.msg,o.img_list),username:o.username}),o.img_list.length>0?t.img_list[o.date]=d.imgSanitization(o.img_list):null}),(n||s)&&t.isChatBox?c.scrollToPos():o.at&&o.at.indexOf("@"+S.username)>=0?t.newMsgNotify("atMsg",o.username,o.date):s||t.contentItem||t.newMsgNotify("newMsg","新消息")}function m(){e.socket.on("connect",function(){e.socket.emit("latestMsg",t.msgInbox.length>=0),e.socket.on("latestMsg",function(e){t.msgInbox=[];for(var o=e.length,s=0;o>s;s++)t.$apply(function(){t.msgInbox.push({isMe:S.username===e[s].username,isImg:e[s].img_list.length>0,isShowDate:0===s?!0:!1,date:e[s].date,msg:d.msgSanitization(e[s].msg,e[s].img_list),username:e[s].username}),e[s].img_list.length>0?t.img_list[e[s].date]=d.imgSanitization(e[s].img_list):null})})}),e.socket.on("textMsg",function(e){w(e)}),e.socket.on("userJoin",function(e){t.onUserIO(e)}),e.socket.on("disconnect",function(e){t.onUserIO(e)})}function x(){e.socket=io("",{query:"token="+B,secure:!0}),m()}function h(){e.socket.disconnect(),e.socket.connect("",{query:"token="+B,secure:!0}),m()}function y(){for(var e=n.localStorage,t=localStorage.length,o=/^todayNews-/,s=0,i=0;t>i;i++)o.test(e.key(s))?g.remove(e.key(s)):s++}e.isSubmit=!1,t.isSun="daytime"===l.getDaytimeOrNight((new Date).getHours())?!0:!1,t.isChatBox=!0,t.isInfoBox=!1,t.isShowNewsOptions=!1,t.isLoadErr=!1,t.toggleChatBox=function(e,o){e?"left"===e?t.isChatBox?t.isChatBox=!t.isChatBox:null:"right"===e&&(t.isChatBox||"infoBox"!==t.currentPage?t.toggleCurrentPage("infoBox"):t.isChatBox=!t.isChatBox,o?t.isShowNewsOptions=!1:null):(t.isChatBox?null:t.toggleCurrentPage("infoBox"),t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,o?t.isShowNewsOptions=!1:null),t.now_img_list=[],t.isZoomIn=!1},t.currentPage="infoBox",t.currentPageIs=function(e){return t.currentPage===e},t.toggleCurrentPage=function(e,o){"geoBox"===t.currentPage&&s(function(){t.geoBox.distance=""},717),o?t.isShowNewsOptions=!1:null,s(function(){t.currentPage=e})};var B=g.get("id_token"),S=a.decodeToken(B);t.infoBox={title:"加入於",username:S.username,numero:S.numero,date:r("date")(S.date,"yyyy 年 M 月 d 日"),country:S.country,partsOfADay:l.partsOfADay(~~r("date")(S.date,"H")),weather:S.weather.description},t.numero=function(e){return l.getNumero(t.infoBox.numero)},t.getDaytimeOrNight=l.getDaytimeOrNight(~~r("date")(S.date,"H")),t.partWeather="",t.togglePartWeather=function(){t.partWeather==u.getCityWeatherType(S.weather.code)?(t.partWeather="",s(function(){t.infoBox.title="加入於"},777)):(t.partWeather=u.getCityWeatherType(S.weather.code),s(function(){t.infoBox.title="當日天氣"},777))},t.otherUserInfo={},t.otherUserInfoId=0,t.toggleOtherUserInfo=function(e,s){return s===t.otherUserInfoId?void(t.otherUserInfoId=0):void(g.get(e)?(t.otherUserInfo=g.get(e),t.otherUserInfoId=s):o.post("/api/getUserInfo",{username:e}).success(function(o,n,i,a){var c={numero:o.msg.numero,country:o.msg.country||"CN",date:r("date")(o.msg.date,"yyyy 年 M 月 d 日")};g.set(e,c),t.otherUserInfo=c,t.otherUserInfoId=s}).error(function(e,t,o,s){}))},t.isTodayNews=!1,t.isNewsExist=!1,t.toggleNewsExist=function(){t.isNewsExist=!t.isNewsExist},t.newsErrMsg="此時段新聞不存在",t.newsDateTitle="當日新聞",t.selectDateNewsBox=[],t.selectDate=(new Date).getHours(),t.selectCountry=t.infoBox.country||"CN";var p=(new Date).getTimezoneOffset()/60,N=g.getNamespacedStore("todayNews","-"),v=function(e){var n=s(function(){t.isLoadErr=!0},1e4);o.post("/api/getSelectedDateNews",{selectDate:t.selectDate,selectCountry:t.selectCountry,timezoneOffset:p,isTodayNews:t.isTodayNews}).success(function(t,o,i,r){s.cancel(n),e("ok",t.msg)}).error(function(o,i,r,a){401===i?t.quit():(400===i?s.cancel(n):null,e("error",o.msg||"網絡出錯，請稍候再試"))})},C=function(e,t){N.set(e,t),g.set("todayNewsExpires",l.getDayMs(new Date))};t.toggleTodayNews=function(){t.isTodayNews=!t.isTodayNews,t.newsDateTitle=t.isTodayNews?"今日新聞":"當日新聞",t.getSelectedDateNews()},t.selectNextCountry=function(){var e=["CN","HK","TW","US","JP","DE","FR","IN","KR","RU","BR"];t.selectCountry=e[e.indexOf(t.selectCountry)+1]||"CN",t.getSelectedDateNews()},t.getSelectedDateNews=function(){var e=l.getDayMs(t.isTodayNews?new Date:S.date)+t.selectCountry+t.selectDate,o=t.isTodayNews?N.get(e):g.get(e);t.isShowNewsOptions=!0,t.isLoadErr=!1,o?(t.selectDateNewsBox=o,"infoBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.isNewsExist?null:t.toggleNewsExist()):(t.toggleCurrentPage("loadBox"),v(function(o,s){"ok"===o?(t.isNewsExist?null:t.toggleNewsExist(),s?t.isTodayNews?C(e,s):g.set(e,s):t.isNewsExist?t.toggleNewsExist():null,t.selectDateNewsBox=s,"loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null):("loadBox"===t.currentPage?t.toggleCurrentPage("newsBox"):null,t.newsErrMsg=s,t.isNewsExist?t.toggleNewsExist():null)}))},t.previousHour=function(){t.selectDate>1?(t.selectDate--,t.getSelectedDateNews()):(t.selectDate=24,t.getSelectedDateNews())},t.nextHour=function(){t.selectDate<24?(t.selectDate++,t.getSelectedDateNews()):(t.selectDate=1,t.getSelectedDateNews())},t.gotoSettingBox=function(){"infoBox"===t.currentPage?t.toggleCurrentPage("settingBox"):null},t.isMuted=!!g.get("isMuted"),t.toggleMuted=function(){t.isMuted=!t.isMuted,g.set("isMuted",t.isMuted)},t.quit=function(){g.remove("id_token"),g.remove("isGeoServices"),t.msgInbox=[],e.socket.disconnect(),i.path("/").replace()},t.isGeoServices=g.get("isGeoServices")||S.isGeoServices,t.toggleGeoServices=function(){o.post("/api/toggleGeoServices",{isGeoServices:!t.isGeoServices}).success(function(e,o,s,n){"on"===e.msg?(g.set("isGeoServices",!0),g.set("nextStep","geoServices"),t.$emit("preTurnOnGeoServices","已開啟服務，請重新登錄")):(g.set("isGeoServices",!1),t.$emit("preTurnOffGeoServices","已關閉服務，請重新登錄")),t.quit()}).error(function(e,o,s,n){401===o?t.quit():null})},t.geoBox={},t.weatherBox={},t.isSameDay=!1,t.getGeoServices=function(){if(t.isGeoServices)if(t.geoBox.distance)"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null;else{if("infoBox"===t.currentPage){t.toggleCurrentPage("loadBox"),t.isLoadErr=!1;var e=s(function(){t.isLoadErr=!0},1e4)}n.navigator.geolocation.getCurrentPosition(function(n){o.post("/api/getGeoServices",{coords:{lat:n.coords.latitude,lon:n.coords.longitude}}).success(function(o,n,i,r){s.cancel(e);var a=o.msg.last_geo.weather.code,g=o.msg.last_geo.weather.isNight,c=o.msg.now_geo.weather.code,d=o.msg.now_geo.weather.isNight;last_weather=u.getGeoWeatherType(a,g),now_weather=u.getGeoWeatherType(c,d),t.geoBox=o.msg,t.geoBox.distance=u.getDistance(o.msg.last_geo,o.msg.now_geo),t.weatherBox={last_weather:last_weather,now_weather:now_weather},t.isSameDay=l.isSameDay(t.geoBox.now_geo.date,t.geoBox.last_geo.date),"loadBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null,s(function(){new Vivus("last_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+last_weather+".svg"},function(){f("last_weather_svg","#CECECF")}),new Vivus("now_weather_svg",{type:"delayed",duration:50,file:"public/img/Climacons_Font/"+now_weather+".svg"},function(){f("now_weather_svg","#000")})})}).error(function(e,o,s,n){401===o?t.quit():404===o?t.isLoadErr=!0:null})})}else"infoBox"===t.currentPage?t.toggleCurrentPage("geoBox"):null},t.atUser=[],t.isUserOnline=function(e){return t.onlineUser.indexOf(e.slice(1))>=0},t.$watch("msgOutbox.textMsg",function(e,o){var s=e.match(/\@([^\s\@]){1,16}/g);if(s&&s!==t.atUser){for(var n=s.length,i=0;n>i;i++)t.atUser.indexOf(s[i])<0?t.atUser.push(s[i]):null;for(var r=t.atUser.length,i=0;r>i;i++)s.indexOf(t.atUser[i])<0?t.atUser.splice(i,1):null}else t.atUser=[]}),t.msgInbox=[],t.msgOutbox={textMsg:""},t.emitTextMsg=function(){var o=t.msgOutbox.textMsg.match(/\@([^\s\@]){1,16}/g);""!==t.msgOutbox.textMsg&&(e.socket.emit("textMsg",{id:e.socket.id,msg:t.msgOutbox.textMsg,username:t.infoBox.username,at:o}),t.atUser="",t.msgOutbox.textMsg=""),t.isZoomIn=!1},e.socket?h():x(),"geoServices"===g.get("nextStep")&&(t.isChatBox=!t.isChatBox,t.isSun=!t.isSun,t.getGeoServices(),g.remove("nextStep")),g.get("todayNewsExpires")<Date.now()?y():null}]);
